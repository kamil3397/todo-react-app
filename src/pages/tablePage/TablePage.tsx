...
import { DataGrid, GridColDef, GridRowParams, GridSortModel, useGridApiRef } from "@mui/x-data-grid";
...
const columns: GridColDef[] = [
  ...
  {
    field: "completionTime", headerName: "Completion Time", width: 100,
...
const TablePage: FC = () => {
  ...
  return (
    ...
    >
      ...
      <Button variant="contained" sx={{ m: 2 }} onClick={() => toggleDrawer(true)}>
        +
      </Button>
